PRUEBA DE CONOCIMIENTO MILLIONANDUP
...
Para poner en funcionamiento la respectiva prueba, es necesario seguir los siguientes pasos:
 ...
 - Ir al proyecto MillionAndUp.Admin.API
 - Ir a la sección de appsettings.json
 - dentro del archivo .json ubicar la llave "connectionStrings"
 - dentro de esa llave modificar el valor de la llave "conn" con los datos de la cadena de conexión del servidor
	donde se va a correr la bd. (actualizar las llaves de server, user y password)
